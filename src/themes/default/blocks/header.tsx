  ...
  return (
    <>
      ...
      >
        <div
          className={cn(
            'absolute inset-x-0 top-0 z-50 h-12 border-transparent ring-1 ring-transparent transition-all duration-300',
            ...
            'has-data-[state=open]:ring-foreground/5 has-data-[state=open]:bg-card/75 has-data-[state=open]:h-[calc(var(--navigation-menu-viewport-height)+3rem)] has-data-[state=open]:border-b has-data-[state=open]:shadow-lg has-data-[state=open]:shadow-black/10 has-data-[state=open]:backdrop-blur',
        ...
        >
          <div className="container">
            <div className="relative flex flex-wrap items-center justify-between lg:py-2">
              <div className="flex justify-between gap-8 max-lg:h-12 max-lg:w-full max-lg:border-b">
                {/* Brand Logo */}
